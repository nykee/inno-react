    ...
    render() {
        ...
        return (
            <div style={{color:'#fff',paddingLeft:'0.5rem'}} id="Dash">
                <Row gutter={2}>
                    <Col xxl={{span:17}} lg={{span:17}}  md={{span:24}} sm={{span:24}} xs={{span:24}} style={{marginTop:'.8rem'}}>
                        <MonthlySummary/>
                    </Col>
                    <Col xxl={{span:7}} lg={{span:7}}  md={{span:24}} sm={{span:24}} xs={{span:24}} style={{marginTop:'.8rem'}}>
                        <PercentCount/>
                    </Col>
                </Row>
