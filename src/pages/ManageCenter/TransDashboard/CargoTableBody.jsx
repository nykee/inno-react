        ...
        return (
            <Row >
                {this.props.datasource.map((data,i)=>{
                    return (
                        <Row key={i}>
                            <Col span={6} style={tableBodyStyleLeft} >{data.carNum}</Col>
                            <Col span={6} style={tableBodyStyle}>{data.warehouseNum}</Col>
                            <Col span={6} style={tableBodyStyle}>{data.loadingStatus}</Col>
                            <Col span={6} style={tableBodyStyle}>{data.finishTime}</Col>
                        </Row>
                    )
                })}
            </Row>
